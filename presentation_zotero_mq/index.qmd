...
- Dans votre navigateur<br><br><br>
- Dans votre OS<br><br><br>
- Dans votre traitement de texte<br><br><br>
- En LaTeX et Markdown

![](images/chromium.png){.absolute top=150 right=450 width=10%}
![](images/firefox.png){.absolute top=150 right=300 width=10%}
![](images/brave.png){.absolute top=150 right=150 width=10%}

![](images/linux.png){.absolute top=320 right=600 width=10%}
![](images/windows.png){.absolute top=320 right=450 width=10%}
![](images/macos.png){.absolute top=320 right=300 width=10%}

![](images/word.png){.absolute top=490 right=320 width=10%}
![](images/libre.png){.absolute top=490 right=150 width=10%}

![](images/overleaf.png){.absolute top=660 right=450 width=10%}
![](images/quarto.png){.absolute top=660 right=100 width=30%}