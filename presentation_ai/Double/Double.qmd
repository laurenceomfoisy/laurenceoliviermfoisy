...
## Qui suis-je? {background-image="IMG_8211.jpeg"}

::: notes
Quizz: Qu'est-ce que c'est?
:::

## Qui suis-je? {background-image="DSC_0553.JPG" background-color="black"}
...
## Principaux champs de l'IA {background-image="16275761882698_15807254862923_Capture d’écran 2020-02-03 à 11.22.33.jpeg" width="1000" height="650" background-size="contain"}
...
## Focus sur ChatGPT {background-image="chat_gpt.jpg" background-size="contain" background-color="black"}
...
##  {background-image="chat_gpt_solution.jpeg"}
...
::: fragment
::: r-stack
![](gyudon.jpg){.fig-align="center"}
:::
:::

##  {background-image="recette_gyudon.jpeg" background-size="cover"}

## L'IA en science sociale {.smaller}

-   Peterson et al. 2021
    -   S'intéressent à comprendre comment les individus prennent des décisions, utilise l'IA afin de traiter une importante quantité de donnée rapidement.
-   Park et al. 2023
...
# Merci! {background-image="kyoto_fin.JPG" background-color="black"}
